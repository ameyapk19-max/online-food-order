...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Create your FoodHub account to start ordering." },
    ],
  }),
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col px-4 py-12">
      <div className="mb-6 flex flex-col items-center text-center">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Join FoodHub using Firebase Auth.</p>
      </div>
